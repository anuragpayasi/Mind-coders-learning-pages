...
export default function BoxModel() {
  return (
    <div className="w-full min-h-screen px-8 py-8 bg-white text-gray-900">
      ...
      <pre className="bg-[#0b1e39] text-green-300 p-6 rounded text-sm overflow-x-auto whitespace-pre border border-gray-300">
{String.raw`
┌───────────────────────────────────────────────┐
│                    Margin                     │
│   ┌────────────────────────────────────────┐   │
...
`}
      ...
      <pre className="bg-[#0b1e39] text-green-300 p-4 rounded text-sm overflow-x-auto whitespace-pre border border-gray-300 mt-4">
{String.raw`
.box {
  width: 200px;
  padding: 20px;
